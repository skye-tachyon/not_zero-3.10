...
//	|| check_v2_signature(path, 0x396, "f415f4ed9435427e1fdf7f1fccd4dbc07b3d6b8751e4dbcec6f19671f427870b")  // rsuntk/KernelSU, temp remove, reason: old handle_sepolicy, old selinux domain
	);
}
